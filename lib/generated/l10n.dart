...
class S {
  ...
  /// `Name`
  String get newStreamDialogNameLabel {
    return Intl.message(
      'Name',
      name: 'newStreamDialogNameLabel',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Name of the stream.`
  String get newStreamDialogNameHint {
    return Intl.message(
      'Name of the stream.',
      name: 'newStreamDialogNameHint',
      desc: '',
      args: [],
    );
  }
  ...
  String get newStreamNameInvalid {
    return Intl.message(
      'Please a name for the stream.',
      name: 'newStreamNameInvalid',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Radio Browser`
  String get menuRadioBrowser {
    return Intl.message(
      'Radio Browser',
      name: 'menuRadioBrowser',
      desc: '',
      args: [],
    );
  }
  ...
  String get couldNotAddTracksToTracklistError {
    return Intl.message(
      'Could not add tracks to tracklist.',
      name: 'couldNotAddTracksToTracklistError',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Could not add tracks to Playlist '{p}'.`
  String couldNotAddTracksToPlaylistError(Object p) {
    return Intl.message(
      'Could not add tracks to Playlist \'$p\'.',
      name: 'couldNotAddTracksToPlaylistError',
      desc: '',
      args: [p],
    );
  }
